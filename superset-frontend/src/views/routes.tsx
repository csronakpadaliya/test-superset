...
const Test = lazy(
  () =>
    import(
      /* webpackChunkName: "RowLevelSecurityList" */ 'src/pages/Test'
    ),
);

const TestChartRender = lazy(
  () =>
    import(
      /* webpackChunkName: "RowLevelSecurityList" */ 'src/pages/TestChartRender'
    ),
);
...
export const routes: Routes = [
  ...
  {
    path: '/test-chart-render/',
    Component: TestChartRender,
  },
  {
